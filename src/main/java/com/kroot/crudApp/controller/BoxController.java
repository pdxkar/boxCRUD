package com.kroot.crudApp.controller;

import com.kroot.crudApp.dto.BoxDTO;
import com.kroot.crudApp.model.Box;
import com.kroot.crudApp.service.BoxNotFoundException;
import com.kroot.crudApp.service.BoxService;
...
public class BoxController extends AbstractController {
    ...
    protected static final String MODEL_ATTRIBUTE_BOX = "box";
    ...
    public String delete(@PathVariable("id") Long id, RedirectAttributes attributes) {
        ...
        try {
            ...
            addFeedbackMessage(attributes, FEEDBACK_MESSAGE_KEY_BOX_DELETED, deleted.getBoxType());
    ...
    public String showCreateBoxForm(Model model) {
        ...
        model.addAttribute(MODEL_ATTRIBUTE_BOX, new BoxDTO());
    ...
    public String submitCreateBoxForm(@Valid @ModelAttribute(MODEL_ATTRIBUTE_BOX) BoxDTO created, BindingResult bindingResult, RedirectAttributes attributes) {
        ...
        addFeedbackMessage(attributes, FEEDBACK_MESSAGE_KEY_BOX_CREATED, box.getBoxType());
    ...
    public String showEditBoxForm(@PathVariable("id") Long id, Model model, RedirectAttributes attributes) {
        ...
        model.addAttribute(MODEL_ATTRIBUTE_BOX, constructFormObject(box));
    ...
    public String submitEditBoxForm(@Valid @ModelAttribute(MODEL_ATTRIBUTE_BOX) BoxDTO updated, BindingResult bindingResult, RedirectAttributes attributes) {
        ...
        try {
            ...
            addFeedbackMessage(attributes, FEEDBACK_MESSAGE_KEY_BOX_EDITED, box.getBoxType());
        } catch (BoxNotFoundException e) {
